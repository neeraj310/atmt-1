...
def get_args():
    ...
    parser.add_argument('--batch-size', default=16, type=int, help='maximum number of sentences in a batch')
    ...
    parser.add_argument('--save-dir', default='checkpoints17', help='path to save checkpoints')
